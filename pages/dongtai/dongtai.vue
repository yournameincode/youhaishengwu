<template>
	...
	:current="tabIndex"
	@change="tabChange">
		<swiper-item v-for="(items,index) in newslist" :key="index" style="height:600px"> 
			<scroll-view scroll-y class="list" @scrolltolower="loadmore(index)" style="height:600px">
				...
				newslist:[
					{
						list:[
							{
								userpic:"../../static/dongtai/touxiang.png",
								username:"赖秋萍老公",
								isguanzhu:false,
								title:"你好！",
								titlepic:"../../static/dongtai/dongtai.jpg",
								type:"image",
								infonum:{
									dingnum:30,
									cainum:1,
